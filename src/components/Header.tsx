...
const Header = () => {
  return (
    <header className="flex justify-between max-w-7xl mx-auto py-6 items-center border-b-2 border-gray-200">
      <Link to="/">
        <div className="font-bold text-purpleL text-3xl font-mono underline w-screen flex-c md:w-full ">
        <CloudIcon className="w-8 h-8 mr-2"/> WorkPod.io
        </div>
      </Link>

      <div className="items-center text-lg space-x-5 mr-4 font-main hidden md:flex">
        <h3 className="bg-purpleL px-6 py-2 rounded-lg text-white shadow-md cursor-pointer flex-c">
          Login <LockOpenIcon className="w-6 h-6 ml-2"/>
        </h3>
        <h3 className="border text-purpleL border-primary px-4 py-2 rounded-lg shadow-lg cursor-pointer flex-c">
