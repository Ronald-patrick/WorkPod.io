      ...
      <Wrapper>
        <div className="flex flex-col justify-center items-center w-full text-center font-main h-[70vh]">
          <div className="font-bold text-[40px] md:text-[60px] ">
            ...
            <span className="text-primary">Work Pod Environment</span>
          </div>
          ...
          <div className="flex gap-5">
            <Link to="/projects" className="bg-primary px-6 py-2 rounded-md text-white shadow-md cursor-pointer text-xl flex gap-3">
